...
class Tester(object):
    ...
    def __init__(self):
        ...
        self.loop = asyncio.get_event_loop()    # 获取EventLoop
    ...
    async def test(self, proxy: Proxy):
        ...
        :return:
        """
        async with aiohttp.ClientSession(connector=aiohttp.TCPConnector(ssl=False)) as session: # async 异步上下文管理器
            try:
